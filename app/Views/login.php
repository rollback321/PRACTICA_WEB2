...
<script src="<?= base_url() ?>js/login_peticion.js">
			...
			$.ajax({
				...
				success: function(json) {
					if (json == '1') {
						...
						window.location.replace("<?= base_url(route_to('main'))?>");  //permite redirigir segun la url sin guardar en historial
					} else {
